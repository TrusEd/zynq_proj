...
#
# zynq_proj.tcl: Tcl script for re-creating project 'zynq_proj'
#
# Generated by Vivado on Wed Nov 22 14:20:38 +0800 2017
...
#
#    "C:/fpga_work/zynq_proj/zynq_proj/zynq_proj.srcs/sources_1/bd/design_1/design_1.bd"
#    "C:/fpga_work/zynq_proj/zynq_proj/zynq_proj.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "C:/fpga_work/zynq_proj/zynq_proj/zynq_proj.srcs/constrs_1/new/pl_pin.xdc"
#
#*****************************************************************************************
...
# Create project
create_project zynq_proj ./zynq_proj -part xc7z030sbg485-1
...
set obj [get_projects zynq_proj]
set_property -name "board_connections" -value "" -objects $obj
set_property -name "board_part" -value "" -objects $obj
set_property -name "compxlib.activehdl_compiled_library_dir" -value "$proj_dir/zynq_proj.cache/compile_simlib/activehdl" -objects $obj
set_property -name "compxlib.funcsim" -value "1" -objects $obj
set_property -name "compxlib.ies_compiled_library_dir" -value "$proj_dir/zynq_proj.cache/compile_simlib/ies" -objects $obj
set_property -name "compxlib.modelsim_compiled_library_dir" -value "$proj_dir/zynq_proj.cache/compile_simlib/modelsim" -objects $obj
set_property -name "compxlib.overwrite_libs" -value "0" -objects $obj
set_property -name "compxlib.questa_compiled_library_dir" -value "$proj_dir/zynq_proj.cache/compile_simlib/questa" -objects $obj
set_property -name "compxlib.riviera_compiled_library_dir" -value "$proj_dir/zynq_proj.cache/compile_simlib/riviera" -objects $obj
set_property -name "compxlib.timesim" -value "1" -objects $obj
set_property -name "compxlib.vcs_compiled_library_dir" -value "$proj_dir/zynq_proj.cache/compile_simlib/vcs" -objects $obj
...
set_property -name "ip_output_repo" -value "$proj_dir/zynq_proj.cache/ip" -objects $obj
...
set files [list \
 "[file normalize "$origin_dir/zynq_proj.srcs/sources_1/bd/design_1/design_1.bd"]"\
 "[file normalize "$origin_dir/zynq_proj.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/zynq_proj.srcs/sources_1/bd/design_1/design_1.bd"
...
set file "$origin_dir/zynq_proj.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
